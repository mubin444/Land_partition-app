...
class ScaleneTrianglePartitionView(BoxLayout):
    def __init__(self, popup_ref=None, **kwargs):
        ...
        self.visualizer = TriangleVisualizer(size_hint_y=None, height=400)
        content.add_widget(self.visualizer)

        btn_box = BoxLayout(orientation='horizontal', spacing=10, size_hint_y=None, height=42)

        export_btn = Button(text="Export Scaled JPG", bold=True, font_size="13sp",
        ...
        back_btn = Button(text="Back / Close", bold=True, font_size="13sp",
...
class Interactive3DLandVisualizer(Widget):
    ...
    def update_canvas(self, *args):
        ...
        with self.canvas:
            ...
            core_lbl = CoreLabel(text="[Touch & Drag to Rotate Diagram]", font_size=14, bold=True)
            core_lbl.refresh()
            tex = core_lbl.texture
...
class AdvancedLandCalculatorApp(App):
    def build(self):
        ...
        content.add_widget(Label(text="[color=00e5ff][b]Advanced Measure and auto partition[/b][/color]", markup=True, font_size="20sp", size_hint_y=None, height=40))
        ...
        self.target_shotok_in = CenteredTextInput(hint_text="6")
        ...
        diagram_box = BoxLayout(orientation='vertical', spacing=10, size_hint_y=None, height=650)
        self.visualizer = Interactive3DLandVisualizer(size_hint=(1, 1))
        diagram_box.add_widget(self.visualizer)

        diag_btn_box = BoxLayout(orientation='horizontal', spacing=5, size_hint_y=None, height=50)
    ...
    def export_scaled_jpg(self, instance):
        ...
        try:
            ...
            img.save(file_name, "JPEG", quality=100, subsampling=0)
